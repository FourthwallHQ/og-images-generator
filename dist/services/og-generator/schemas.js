...
export const OGImageShopRequestSchema = z.object({
    offerImagesUrls: z.array(z.string().url()).min(1).openapi({
        example: [
    ...
    stylesUrl: z.union([z.string().url(), z.literal('')]).optional().default('').openapi({
        example: 'https://sandbox-shop.fourthwall.com/platform/style.css',
        description: 'URL to CSS file with shop styles'
    }),
    logoUrl: z.union([z.string().url(), z.literal('')]).optional().default('').openapi({
